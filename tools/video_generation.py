...
def parse_args():
    ...
    parser.add_argument(
        ...
        default="mp4",
        type=str,
        choices=["mp4", "avi"],dino/video_generation.py /
        @mathildecaron31
        mathildecaron31 resize img in visu
        Latest commit 9417599 on 9 Jun, 2021
         History
         3 contributors
        @aquadzn@mathildecaron31@piotr-bojanowski
        378 lines (333 sloc)  13.3 KB
